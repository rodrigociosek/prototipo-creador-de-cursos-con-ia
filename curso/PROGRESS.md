...
- [ ] Fase 8 — Clases de construcción generadas (ver detalle abajo) — EN CURSO (Clase 04 de 57 hecha)
...
- [ ] Clase 05 — Persistencia simulada crear/leer (K6) — [conocimiento] — SIGUIENTE
... (Clases 06 a 57 según curso/indice.md, se van agregando a esta lista a medida que se acercan — ver curso/indice.md para el detalle completo de las 57)
...
Fase 8 en curso. Clase 01 (React y componentes, K10), Clase 02 (formulario controlado, K11), Clase 03 (construcción — interfaz, T-03) y Clase 04 (Express, HTTP, JSON, códigos de estado, K1/K3/K4/K5) hechas el 2026-07-22, cada una en su rama, commiteadas.
...
Próximo paso: Clase 05 (conocimiento — persistencia simulada, K6).
